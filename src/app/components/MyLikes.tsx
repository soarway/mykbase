...
const mockLikedFiles: LikedFile[] = [
  { id: '1', name: '机电运维中心站台门系统故障周报[2024]PSD-GZZB-001号', owner: '有米', likeTime: '昨天 20:23' },
  { id: '2', name: '机电运维中心站台门系统故障周报（2025年02月03日～2025年02月09日）红头版本', owner: '有米', likeTime: '昨天 20:23' },
  { id: '3', name: '机电运维中心站台门系统故障周报（2025年01月27日～2025年02月02日）红头版本', owner: '有米', likeTime: '昨天 20:23' },
  { id: '4', name: '机电运维中心站台门系统故障周报（2025年01月20日～2025年01月26日）红头版本', owner: '有米', likeTime: '昨天 20:23' },
  { id: '5', name: '机电运维中心站台门系统故障周报（2025年01月13日～2025年01月19日）红头版本', owner: '有米', likeTime: '昨天 20:23' },
  { id: '6', name: '机电运维中心站台门系统故障周报（2025年01月06日～2025年01月12日）红头版本', owner: '有米', likeTime: '昨天 20:23' },
  { id: '7', name: '机电运维中心站台门系统故障周报（2024年12月9日～12月15日）红头版本', owner: '有米', likeTime: '昨天 20:23' },
];
...
export function MyLikes() {
  ...
  const totalItems = mockLikedFiles.length;
            ...
            <tbody>
              {mockLikedFiles.map((file) => (
                <tr key={file.id} className="border-b border-[#d2d2d7]/50 hover:bg-[#f5f5f7]/50 transition-colors cursor-pointer">
                  ...
                  <td className="px-6 py-3 text-[14px] text-[#1d1d1f]">{file.likeTime}</td>
                </tr>
              ))}
            </tbody>
          </table>
